...
using(var libVLC = new LibVLC())
{
    var media = new Media(_libVLC, "https://download.blender.org/peach/trailer/trailer_480p.mov", FromType.FromLocation);
...
```csharp
using var libVLC = new LibVLC();
using var media = new Media(libVLC, new Uri("https://download.blender.org/peach/trailer/trailer_480p.mov"));
