...
namespace ConsoleApp1
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            mediaPlayer.SetMedia(new Uri("https://download.blender.org/peach/trailer/trailer_480p.mov"), mediaOptions);
...
namespace ConsoleApp1
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            mediaPlayer.Media = new Media(new Uri("https://download.blender.org/peach/trailer/trailer_480p.mov"), mediaOptions);
